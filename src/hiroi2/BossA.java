...
//				SprayShooter.singleton.shoot(ginfo, stage, BossA.this.position); 弾が途中で止まる
				SplatterShooter.singleton.shoot(ginfo, stage, BossA.this.position);
//				TargetShooter.singleton.shoot(ginfo, stage, BossA.this.position);  何でか斜めに飛んでくる
				RollingShooter.singleton.shoot(ginfo, stage, BossA.this.position);
//				BasicShooter.singleton.shoot(ginfo, stage, BossA.this.position); 追っかけてくる
