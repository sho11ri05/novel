...
public class BossB1 extends GameChara {
	...
	public BossB1(){
		...
		this.patternlist_addlast(new PatternHalt(1700));
	...
	class PatternB1 extends Pattern{
		...
		public boolean isFinished(GraphicsInfo ginfo) {
			if(BossB1.this.position.y > 200) return true;
			return false;
		}
		@Override
		public void move(GraphicsInfo ginfo, Stage stage) {
			BossB1.this.position.y += 120 * ginfo.frametime;
		}
	}
	//停止
	...
	class PatternA2 extends Pattern{
		@Override
		public boolean isFinished(GraphicsInfo ginfo) {
			if(BossB1.this.position.x < 100) return true;
			return false;
		}
		@Override
		public void move(GraphicsInfo ginfo, Stage stage) {
			BossB1.this.position.x -= 240 * ginfo.frametime;
		}
	}
	//右移動
	class PatternA3 extends Pattern{
		@Override
		public boolean isFinished(GraphicsInfo ginfo) {
			if(BossB1.this.position.x > 800-100) return true;
			return false;
		}
		@Override
		public void move(GraphicsInfo ginfo, Stage stage) {
	...
	class PatternA4 extends Pattern{
		@Override
		public boolean isFinished(GraphicsInfo ginfo) {
			if(BossB1.this.position.y > 720-100) return true;
			return false;
		}
		@Override
		public void move(GraphicsInfo ginfo, Stage stage) {
			BossB1.this.position.y += 240 * ginfo.frametime;
		}
	}
	//上移動
	class PatternA5 extends Pattern{
		@Override
		public boolean isFinished(GraphicsInfo ginfo) {
			if(BossB1.this.position.y < 100) return true;
			return false;
		}
		@Override
		public void move(GraphicsInfo ginfo, Stage stage) {
	...
	class PatternB4 extends Pattern{
		...
		public void move(GraphicsInfo ginfo, Stage stage) {
			...
			if(ginfo.currenttime - this.lastshooting > 1000){
				WideShooterL.singleton.shoot(ginfo, stage, BossB1.this.position);
